...
const banmsgtype = '*Corre miembro del grupo, tu boleto casi esta cerca✈*'
// mensagem de ban no anti tipos de mensagem

const adminmsgtype = '*Eres admin te salvaste😉*'
// mensagem de quando adm manda tipos de mensagens proibidas

const banmsgporn = '*pinche Pajero🙄* ...'
// mensagem de ban no antiporn

const adminmsgporn = '*Vaya vaya un admin jala ganso🧐*'
...
const adminmsgpalavra = 'Te salvaste por ser admin JUM😑'
// mensagem de quando adm manda uma palavra proibida pelo bot

const banmsgpalavra = '*AQUI NO SE DICEN PALABROTAS, PINCHE MALCRIADO🧐*'
...
const textmsgday = 'Weeenosss días guap@sss 👉👈'
...
const botfeio = 'Tu madre vieja loca 😑'
const cadebot = 'Me llamó onii-chan 👉👈?'
const botfdp = 'Calla cagada'
const botgostoso = 'Ojo 😳👉👈'
const botfofo = 'Ojo 😳👉👈'
const botbaianor = 'La tuya pinche peruculo☝🏽'
const botcorno = 'Vete a Comer caca😊'
const botputa = 'Tú pinche madre tonto😡'
const botgay = 'Respeta pelotudo de mierd💩😡'
const botviado = 'Calla pvto 😡'
const numbotfeio = 'Dama a tú prima 😡'
// KEYS
...
let mess = {
    ...
    error: {
        stick: '❌ No se pudo convertir a sticker Re menso❌',
        Iv: '❌ Link inválido ❌'
    },
    only: {
